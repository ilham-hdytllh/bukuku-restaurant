...
class UpdateBranchScreen extends StatelessWidget {
  const UpdateBranchScreen({super.key});
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: Obx(
            () => ElevatedButton(
              onPressed: branchController.isLoadingUpdate.value == false
                  ? () => branchController.updateBranchToFirestore(
                      branchController.selectedBranchID.value)
                  : null,
              child: branchController.isLoadingUpdate.value == false
                  ? Text("edit".tr)
                  : const Center(
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
