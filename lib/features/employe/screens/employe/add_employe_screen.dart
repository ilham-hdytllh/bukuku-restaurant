...
class AddEmployeScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: Obx(
            () => ElevatedButton(
              onPressed: employeController.isLoadingAdd.value == false
                  ? () => employeController.saveEmployeRecord()
                  : () {},
              child: employeController.isLoadingAdd.value == false
                  ? Text("add".tr)
