...
enum RotatedDirection { none, left, right, upsideDown }

class ChairSingleSheet extends StatelessWidget {
  final bool rotate;
  final RotatedDirection rotateDirection;

  const ChairSingleSheet({
    super.key,
    this.rotate = false,
    this.rotateDirection = RotatedDirection.none,
  });
