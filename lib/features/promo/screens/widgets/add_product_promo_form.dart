...
class AddProductPromoForm extends StatelessWidget {
  const AddProductPromoForm({super.key});
          ...
          children: [
                      ...
                      children: [
                                ...
                                child: SizedBox(
                                  child: RadioListTile(
                                    ...
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    onChanged: (value) {
                                      promoController.selectedDiscountType
                                          .value = "percent";
                                    },
                                  ),
                                ),
                        ...
                        Obx(
                          () => CheckboxListTile(
                            ...
                            onChanged: (value) => promoController
                                    .selectedPromotionHour.value =
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Obx(
                  () => ElevatedButton(
                    onPressed: promoController.isLoadingAdd.value == false
                        ? () => promoController.savePromo()
                        : () {},
                    child: promoController.isLoadingAdd.value == false
                        ? Text("add".tr)
